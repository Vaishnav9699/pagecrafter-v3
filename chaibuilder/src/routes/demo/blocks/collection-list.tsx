import { builderProp, closestBlockProp, registerChaiBlockProps, StylesProp } from "@chaibuilder/runtime";
import { ChaiBlockComponentProps, ChaiBlockConfig, ChaiStyles } from "@chaibuilder/types/blocks";
