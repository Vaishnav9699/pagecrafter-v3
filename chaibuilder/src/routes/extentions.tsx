import { AiButton, DEFAULT_PANEL_WIDTH } from "@chaibuilder/core/components/layout/root-layout";
import { default as AIChatPanel } from "@chaibuilder/routes/demo/ai-chat-panel";
import registerCustomBlocks from "@chaibuilder/routes/demo/blocks";
import "@chaibuilder/routes/demo/panels/panel";
...
import {
  ...
  registerChaiTopBar,
} from "@chaibuilder/runtime/client";
import { ChaiLibraryBlock } from "@chaibuilder/types/chaibuilder-editor-props";
import { lazy } from "react";
const TopBar = lazy(() => import("@chaibuilder/routes/demo/top-bar"));
