...
import { Card, CardContent, CardHeader, CardTitle } from "@chaibuilder/components/ui/card";
...
import { useDeleteGlobalSchema, useTogglePageGlobalSchema } from "@chaibuilder/pages/hooks/project/mutations";
import { useGlobalJsonLDItems } from "@chaibuilder/pages/hooks/use-global-json-ld";
