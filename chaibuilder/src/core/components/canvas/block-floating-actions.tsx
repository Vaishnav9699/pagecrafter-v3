...
import AddBlockDropdown from "@chaibuilder/core/components/canvas/add-block-placements";
import { useDragAndDrop, useIsDragAndDropEnabled } from "@chaibuilder/core/components/canvas/dnd/drag-and-drop/hooks";
import BlockController from "@chaibuilder/core/components/sidepanels/panels/add-blocks/block-controller";
import { CHAI_BUILDER_EVENTS } from "@chaibuilder/core/events";
import { useFrame } from "@chaibuilder/core/frame/frame-context";
import { canDeleteBlock, canDuplicateBlock } from "@chaibuilder/core/functions/block-helpers";
...
import { useDuplicateBlocks } from "@chaibuilder/hooks/use-duplicate-blocks";
import { useHighlightBlockId } from "@chaibuilder/hooks/use-highlight-blockId";
import { useInlineEditing } from "@chaibuilder/hooks/use-inline-editing";
import { usePermissions } from "@chaibuilder/hooks/use-permissions";
import { useRemoveBlocks } from "@chaibuilder/hooks/use-remove-blocks";
...
import { useSidebarActivePanel } from "@chaibuilder/hooks/use-sidebar-active-panel";
