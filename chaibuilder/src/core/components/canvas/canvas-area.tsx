...
import StaticCanvas from "@chaibuilder/core/components/canvas/static/static-canvas";
...
import { useCodeEditor } from "@chaibuilder/hooks/use-code-editor";
import { noop } from "lodash-es";
import React, { Suspense } from "react";
import { ErrorBoundary } from "react-error-boundary";

const CodeEditor = React.lazy(() => import("@chaibuilder/core/components/canvas/static/code-editor"));
