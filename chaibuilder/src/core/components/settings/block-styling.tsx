import { Accordion } from "@chaibuilder/components/ui/accordion";
import { BlockStylingProps } from "@chaibuilder/core/components/settings/block-styling-props";
import { StylingGroup } from "@chaibuilder/core/components/settings/new-panel/setting-section";
import { BlockSettingsContext } from "@chaibuilder/core/components/settings/settings-context";
import { FLEX_CHILD_SECTION, GRID_CHILD_SECTION, SETTINGS_SECTIONS } from "@chaibuilder/core/constants/STYLING_GROUPS";
import { useSelectedBlocksDisplayChild } from "@chaibuilder/hooks/use-selected-blockIds";
