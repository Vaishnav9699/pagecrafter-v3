import { showPredefinedBlockCategoryAtom } from "@chaibuilder/atoms/ui";
import { ScrollArea } from "@chaibuilder/components/ui/scroll-area";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@chaibuilder/components/ui/tabs";
import { CoreBlock } from "@chaibuilder/core/components/sidepanels/panels/add-blocks/core-block";
import { DefaultChaiBlocks } from "@chaibuilder/core/components/sidepanels/panels/add-blocks/default-blocks";
...
import { PartialBlocks } from "@chaibuilder/core/components/sidepanels/panels/add-blocks/partial-blocks";
import { CHAI_BUILDER_EVENTS } from "@chaibuilder/core/events";
import { canAcceptChildBlock, canBeNestedInside } from "@chaibuilder/core/functions/block-helpers";
import { mergeClasses, PERMISSIONS } from "@chaibuilder/core/main";
...
import { usePartialBlocksList } from "@chaibuilder/hooks/use-partial-blocks-store";
import { usePermissions } from "@chaibuilder/hooks/use-permissions";
import { useChaiAddBlockTabs, useChaiLibraries } from "@chaibuilder/runtime/client";
